...
public final class PlayerHolder {
    ...
    private boolean isInternalListenerSet = false;
    ...
    private void forceRepushServiceDataViaOnServiceConnectedIfConnectedToIt() {
    ...
    public void setListener(final PlayerServiceExtendedEventListener newListener) {
        if (newListener == null) {
    ...
    public synchronized void startService(final boolean playAfterConnect,
                                    final PlayerServiceExtendedEventListener newListener) {
        final Context context = getCommonContext();
        setListener(newListener);
        forceRepushServiceDataViaOnServiceConnectedIfConnectedToIt();
        if (bound) {
            return;
        }
    ...
    private void startPlayerListener() {
        if (player != null && !isInternalListenerSet) {
            isInternalListenerSet = true;
